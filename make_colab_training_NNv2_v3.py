    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "HEURISTIC_PLANES = np.stack([checkerboard, centrality])\n",
                "\n",
                "def _encode_state_batch(envs, device):\n",
                "    n = len(envs)\n",
                "    size = envs[0].size\n",
                "    states = np.empty((n, 5, size, size), dtype=np.float32)\n",
                "    \n",
                ...
                "    states[:, 3] = HEURISTIC_PLANES[0]\n",
                "    states[:, 4] = HEURISTIC_PLANES[1]\n",
                "    \n",
                ...
                "                game_lengths.append(len(game_data[env_idx]))\n",
                "                games_finished += 1\n",
                "                \n",
                ...
                "        states = np.zeros((batch_size, 5, 13, 13), dtype=np.float32)\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "model = SnakyNet(in_channels=5, num_resBlocks=16, num_channels=256, board_size=13).to(device)\n",

...
"""
    ...
    out_path = '/Users/austinanderson/.gemini/antigravity-ide/brain/74ee950e-9fb7-41d6-aa95-d0f9fe25cc07/arena_replay.html'
    with open(out_path, 'w') as f:
        f.write(html_template)
    print(f"Generated visualizer at: {out_path}")

    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "            roots[i].children[move] = Node(parent=roots[i], prior_prob=valid_policy[move])\n",
                "            \n",
                "        if add_noise:\n",
                "            dirichlet_alpha = 0.3\n",
                ...
                "        search_envs = [copy.deepcopy(env) for env in envs]\n",
                ...
                "                games_finished += 1\n",
                "                print(f'Game {games_finished}/{num_games} finished. Moves: {len(game_data[env_idx])}')\n",
                "                \n",
...
print("Training notebook updated with BATcHED MCTS!")

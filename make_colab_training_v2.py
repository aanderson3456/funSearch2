    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# SnakyNet Massive 13x13 Self-Play Training on Colab Pro (VERSION 2 - ULTRA FAST)\n",
                "This notebook trains the 13x13 AlphaGo-style ResNet for the Snakey game using Google Colab A100 GPUs.\n",
                "**Updates in V2:** Fully batched vector MCTS and zero-copy environment branching. Expect 10x-50x speedup."
            ]
        },
        {
            "cell_type": "code",
...
with open("colab_training_v2.ipynb", "w") as f:
    json.dump(notebook, f, indent=2)
print("colab_training_v2.ipynb generated!")

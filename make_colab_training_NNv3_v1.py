    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# SnakyNet Massive 13x13 Self-Play Training on Colab Pro (NNv3_v1)\n",
                "This notebook trains the 13x13 AlphaGo-style ResNet for the Snakey game using Google Colab A100 GPUs.\n",
                "**Updates in NNv3:** \n",
                "1. **6-Channel Input Architecture:** Added a real-time **Greedy Threat Heatmap** plane alongside Maker, Breaker, Turn, Parity, and Centrality.\n",
                "2. **Active Breaker Threat Blocking:** Integrated a fast, vectorized heuristic that directly calculates Maker's progress across all active Snaky shapes.\n",
                "3. **MCTS Search Prior Blending:** During Breaker's turn, MCTS search priors are blended with threat scores, featuring near-100% hard priority on blocking immediate 1-move Maker win threats (5/6 pieces placed)!"
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                ...
                "import os\n",
                "os.makedirs('/content/drive/MyDrive/SnakyNet_v3_Checkpoints', exist_ok=True)"
            ]
        },
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "# --- Heuristic Planes & Precomputed Threat Tables ---\n",
                ...
                "                legal_moves = env.get_legal_moves()\n",
                "                if env.current_player == -1:\n",
                "                    t_map, is_crit = compute_threat_single(env)\n",
                "                    policy = blend_breaker_policy(policy, env, t_map, is_crit)\n",
                ...
                "        states[:, 4] = HEURISTIC_STATIC_PLANES[1]\n",
                "        \n",
                "        # Vectorized threat map for training batch\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "import re\n",
                "all_models = glob.glob('/content/drive/MyDrive/SnakyNet_v3_Checkpoints/snaky_large_model_it*.pt')\n",
                "\n",
                "start_iteration = 0\n",
                "if all_models:\n",
                "    def get_it(path):\n",
                ...
                "import json\n",
                "import os\n",
                "loss_history_path = '/content/drive/MyDrive/SnakyNet_v3_Checkpoints/loss_history.json'\n",
                "loss_history = []\n",
                ...
                "    save_path = f'/content/drive/MyDrive/SnakyNet_v3_Checkpoints/snaky_large_model_it{it}.pt'\n",
...
with open("colab_training_NNv3_v1.ipynb", "w") as f:
    json.dump(notebook, f, indent=2)
print("colab_training_NNv3_v1.ipynb generated!")

# Rank 7 Snakey Maker Strategy
# Fitness Score: 270.00
...
Higher score means Maker prefers this cell."""
  ...
  weights = {0: 1.0, 1: 5.5, 2: 22.3, 3: 585.2, 4: 25000.0, 5: 1000000.0}
  score = 0.0
  active_count = 0
  for shape in active_shapes:
    if candidate in shape:
      ...
      active_count += 1
  score += (active_count ** 1.3) * 2.52
  score -= (abs(candidate[0]) + abs(candidate[1])) * 0.07
  return float(score)

...
Higher score means Maker prefers this cell."""
  ...
  weights = {0: 1.0, 1: 4.8, 2: 25.2, 3: 506.8, 4: 25000.0, 5: 1000000.0}
  score = 0.0
  active_count = 0
  for shape in active_shapes:
    if candidate in shape:
      ...
      active_count += 1
  score += (active_count ** 1.3) * 3.0
  score -= (abs(candidate[0]) + abs(candidate[1])) * 0.09
  return float(score)

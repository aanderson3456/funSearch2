    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# SnakyNet Massive 13x13 Self-Play Training on Colab Pro (VERSION 4)\n",
                "This notebook trains the 13x13 AlphaGo-style ResNet for the Snakey game using Google Colab A100 GPUs.\n",
                "**Updates in V4:** Fixed floating point probabilities crash (numpy strictly demands exactly 1.0) and fixed the harmless but annoying divide-by-zero RuntimeWarning from numpy."
            ]
        },
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "source": [
                ...
                "        \n",
                "        # STRICT NORMALIZATION TO PREVENT NUMPY FLOAT32 CUMULATIVE ERRORS\n",
...
with open("colab_training_v4.ipynb", "w") as f:
    json.dump(notebook, f, indent=2)
print("colab_training_v4.ipynb generated!")
